...
-- -----------------------------------------------
-- Drop tables in safe FK-respecting order
...
-- -----------------------------------------------
-- 4. cart  (depends on users AND products)
-- -----------------------------------------------
...
-- -----------------------------------------------
-- Optional tables (uncomment to enable)
-- -----------------------------------------------
...
--     CONSTRAINT uq_wishlists         UNIQUE (user_id, product_id)
-- );
...
--     description TEXT,
--     created_at  TIMESTAMP    NOT NULL DEFAULT CURRENT_TIMESTAMP,
--     CONSTRAINT fk_for_him_product FOREIGN KEY (product_id) REFERENCES products(id) ON DELETE SET NULL
-- );
...
--     description TEXT,
--     created_at  TIMESTAMP    NOT NULL DEFAULT CURRENT_TIMESTAMP,
--     CONSTRAINT fk_for_her_product FOREIGN KEY (product_id) REFERENCES products(id) ON DELETE SET NULL
-- );
