...
<section class="gift-hero">
  <video class="gift-hero-video" autoplay muted loop playsinline preload="auto">
    <source
      src="${pageContext.request.contextPath}/static/video/dayxnight1.mp4"
      type="video/mp4"
    />
  </video>
...
<style>
    ...
    .gift-hbtn-him {
      background: linear-gradient(135deg, rgba(26, 107, 56, 0.92) 0%, rgba(9, 27, 14, 0.96) 100%);
      border-color: rgba(61, 186, 98, 0.35);
    }
    .gift-hbtn-him:hover {
      background: linear-gradient(135deg, rgba(37, 138, 74, 0.98) 0%, rgba(26, 107, 56, 0.98) 100%);
      border-color: rgba(61, 186, 98, 0.58);
    }

    .gift-hbtn-her {
      background: linear-gradient(135deg, rgba(107, 48, 137, 0.92) 0%, rgba(28, 8, 38, 0.96) 100%);
      border-color: rgba(201, 164, 82, 0.32);
    }
    .gift-hbtn-her:hover {
      background: linear-gradient(135deg, rgba(155, 80, 185, 0.98) 0%, rgba(90, 25, 110, 0.98) 100%);
